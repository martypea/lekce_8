...
class ArticleController extends Controller
{
    ...
    /**
     * @Route("/find-by/{categoryId}", name="article_filter", methods="GET")
     */
     public function categoryAction($categoryId) 
     {
        $articles = $this->getDoctrine()->getRepository(Article::class)->findBy(['category' => $categoryId]);
  ...
  /**
     * @Route("/ajax/test", name="article_ajax", methods="GET|POST")
     */
